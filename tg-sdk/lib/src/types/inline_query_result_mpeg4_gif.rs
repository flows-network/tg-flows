...
impl InlineQueryResultMpeg4Gif {
    pub fn new<S>(id: S, mpeg4_url: url::Url, thumb_url: url::Url) -> Self
    where
        S: Into<String>,
    {
        Self {
    ...
    #[must_use]
    pub fn mpeg4_url(mut self, val: url::Url) -> Self {
        self.mpeg4_url = val;
        self
    }
    ...
    #[must_use]
    pub fn thumb_url(mut self, val: url::Url) -> Self {
        self.thumb_url = val;
        self
    }
